...
//print instrucgtion to player
    public void printInstructions() {
        System.out.println("Welcome to the MadLibs games."
                + " If you type in words, we'll give you a story. Start by typing in a name");
    }
//get data from player
    ...
    public void putTogetherTheStory() {
        ...
        story = "Jesse and her best friend " + getName() + " went to Disney World today! "
            ...
            story = "Amanada and her frenemy " + getName() + " went to the zoo last summer. " +
                    "They saw a huge " + getNoun1()+ " and a tiny little " + getNoun2() + ". That night"
                    + " they decided to climb " + getAdverb()+ " into the " + getNoun3()+ " to get closer look. "
    ...
    public static void main(String[] args) {
        ...
        Day6MadLibs game = new Day6MadLibs();
