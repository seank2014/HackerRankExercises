...
public class Testers {
    ...
    public static int rndInt(int min, int max){
        ...
        return rand.nextInt((10-5) + 1) + min;
        // min = 5, max = 15
...
throw new Exception("All is not good, the tree is an EmptyBST and it is non-empty");
    ...
    public static void checkAddMemberCardinality(Tree t, int x) throws Exception {
      ...
      if(nT == t.cardinality() + 1){
         if(t.member(x)){
             throw new Exception("The cardinality increased by one, but the thing"
      ...
      // 2.OR the thing that was added was already there and threrefore not really added
